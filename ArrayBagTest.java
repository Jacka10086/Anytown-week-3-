...
public class ArrayBagTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ArrrayBag Building[] buildings = new ArrayBag(13)
        ...
        while (fileInput.hasNextLine()) {
            ...
            switch (buildingData.substring(0,1)) {
                ...
                if (buildings.addNewEntry(new Building(address, owner)) == false) {
                ...
                if (buildings.addNewEntry(new House(address, owner, numberOfBedrooms, hasGarage)) == false) {
                ...
                if (buildings.addNewEntry(new Shop(address, owner, numberOfEmplyees, avgTurnover)) == false) {
